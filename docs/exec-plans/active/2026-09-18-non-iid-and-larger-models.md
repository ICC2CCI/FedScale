...
5 轮冒烟 **已通过**：`results/202609210952`，医学 IID + SecAgg，`batch=1`，R5 eval=**1.014**、train 2.58→1.20，上行 ~1.46 GiB/轮，整轮 ~18–20 min。记录见 [7B 医学 SecAgg](../../experiment-records/2026-09-21-qwen25-7b-medical-secagg.md)。
