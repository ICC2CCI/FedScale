...
> **部分过时**：本文是 2026-09-09 的部署规划。双集群 + MinIO + 去 Flower 的方向已落地，  
> 但具体启动命令、端口、SecAgg、结果目录等以  
> [当前联调流程](2026-09-10-dual-cluster-s3r12v3-fsdp-current-flow.md) 为准，不要按本文逐步操作。

- **状态**：superseded（规划已实现；细节见 current-flow）
- **负责人 / Agent**：opencode
- **创建**：2026-09-09
- **更新**：2026-09-18（标注过时）
