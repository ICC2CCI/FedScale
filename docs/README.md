...
| [SecAgg 量化精度问题](algorithm/2026-09-15-secagg-quantization-precision-issue.md) | 完整 SecAgg 流程、amax 隐私、收敛修复 |
| [SecAgg 量化优化调研](algorithm/2026-09-17-secagg-quantization-optimization-survey.md) | Hadamard / Issue #1；20 轮 R20 eval≈0.985 |
