...
OUTPUT_DIR = Path("/data/home/qiaoyanchen/liuchao/fedscale/output/s3r5-sgd-memory")
LOG_PATH = Path("/data/home/qiaoyanchen/liuchao/fedscale/logs/s3r5-sgd-memory.log")
NUM_ROUNDS = 20
